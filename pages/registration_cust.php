...
<main class="form-signin">
    <form method="post" action="../vendor/registration_code.php">
        ...
        <div class="form-floating">
            <input type="text" class="form-control" name="phone" id="floatingPassword" placeholder="phone">
        ...
        <input class="w-100 btn btn-lg btn-primary" name="reg_cust" type="submit"></input>
    </form>
</main>
